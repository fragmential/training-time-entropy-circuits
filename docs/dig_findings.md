...
Models: pythia-1b-deduped (58 ckpts, complete), pythia-6.9b-deduped (58, complete),
OLMo-2-1124-7B (65/66 at time of dig), OLMo-2-0425-1B pending. All numbers are centered,
...
| | pythia-1b | pythia-6.9b | OLMo-2-7B |
|---|---|---|---|
| RankMe (centered, before_final_norm) | 465 → peak 555@4k → 194 | 824 → peak ~546@13k → 260 | 74@150 → peak 939@4k → 646 |
| Σ quality over training | −0.5 → **−6.3** | −0.4 → **−5.0** | dips −5.5@10k → **recovers to −1.3** |
| Σ interference over training | −3.5 → **+2.3** (crosses 0 ≈ RankMe peak) | −4.7 → −0.2 (rising, no cross) | −0.1@6k → **−5.5** (falling) |
| compression driver | quality | quality | **interference** |
| locus | blk3 (90% of Δquality) + blk15 | blk3 (~all of Δquality) + blk31 | late blocks 29–31, distributed |
