...
_ledger_srcs = lambda model: [("block_representations_samples_padded", (f'blk{l}', 'block_ledger'), f'blk {l}')
...
# %%
# Head-removed RankMe + windowed alphaReQ for the final stream AND the stream entering the
# last block, plus λ1/λ2 head dominance. Padded caveat: MP broadening at N/d ~ 4 contaminates
# the deep tail — read the k=128 / 128-512 curves as trends only.
KS = (0, 1, 2, 8, 32, 128)
